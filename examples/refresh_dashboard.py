...
from venomics_client import VenomicsAPIClient, get_frontend_vals


def refresh_dashboard(baseurl, apikey, slug):

    client = VenomicsAPIClient(apikey, baseurl)
...
def fill_dynamic_val(dates, p):
    """Accepts parameter default information from the Venomics API.
